...
echo "🧐 Hello there"
echo ""
echo "This is some statistics for our opencollective contributions (yeah, i mean... monney/'nkap' inside Oss Cameroon):"
echo ""
echo "----------------------------------------------"
echo ""
...
echo "There is no 'small monney', each donations count a lot😉!"
echo ""
